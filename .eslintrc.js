module.exports = {
    ...
    'rules': {
         ...
         * Style
         */
        "id-match": [2, "^[a-z]+(([A-Z]([a-z]|[0-9])+)|([0-9]))*$",{ "properties": true }],// http://eslint.org/docs/rules/id-match
        ...
        "semi": [0, "always",{ "omitLastInOneLineBlock": true }],           // http://eslint.org/docs/rules/semi
        "semi-spacing": [2, {            // http://eslint.org/docs/rules/semi-spacing
            "before": false,
            "after": true
        }],
        "space-before-blocks": 1,        // http://eslint.org/docs/rules/space-before-blocks
        "space-before-function-paren": [2, {"anonymous": "always", "named": "never", "asyncArrow": "ignore"}], // http://eslint.org/docs/rules/space-before-function-paren
