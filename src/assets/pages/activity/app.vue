<template>
    <div id="app">
        ...
        <form action="">
            ...
            <a id="login" class="normal">点击再次体验</a>
    ...
    export default {
        ...
        mounted(){
            ...
            axios.get('http://static.geetest.com/static/tools/gt.js').then(
                axios.request({
                    url: (process.env.NODE_ENV === 'production' ? "./api/fullpage/get?t=" : "http://192.168.0.14:8009/api/fullpage/get?t=") + (new Date()).getTime(), // 加随机数防止缓存
                    method: 'get', // default
                }).then(function (res) {
                    var data = res.data;
                    initGeetest({
